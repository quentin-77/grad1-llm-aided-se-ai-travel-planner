...
const envSchema = z.object({
  ...
  DASH_SCOPE_TIMEOUT_MS: z.string().optional(),
  ALIBABA_SPEECH_APP_ID: z.string().optional(),
  ALIBABA_SPEECH_ACCESS_TOKEN: z.string().optional(),
...
const envResult = envSchema.safeParse({
  ...
  DASH_SCOPE_TIMEOUT_MS: process.env.DASH_SCOPE_TIMEOUT_MS,
  ALIBABA_SPEECH_APP_ID: process.env.ALIBABA_SPEECH_APP_ID,
  ALIBABA_SPEECH_ACCESS_TOKEN: process.env.ALIBABA_SPEECH_ACCESS_TOKEN,
...
export const env = envResult.success
  ...
  : ({
      ...
      DASH_SCOPE_TIMEOUT_MS: undefined,
      ALIBABA_SPEECH_APP_ID: undefined,
      ALIBABA_SPEECH_ACCESS_TOKEN: undefined,
